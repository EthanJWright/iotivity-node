...
static Local<Object> bind_OCTransportBTFlags_t() {
  Local<Object> returnValue = Nan::New<Object>();
  SET_CONSTANT_NUMBER(returnValue, OC_DEFAULT_BT_FLAGS);
  SET_CONSTANT_NUMBER(returnValue, OC_LE_ADV_DISABLE);
  SET_CONSTANT_NUMBER(returnValue, OC_LE_ADV_ENABLE);
  SET_CONSTANT_NUMBER(returnValue, OC_LE_SERVER_DISABLE);
  SET_CONSTANT_NUMBER(returnValue, OC_EDR_SERVER_DISABLE);

  return returnValue;
}
static Local<Object> bind_OCLogLevel() {
  Local<Object> returnValue = Nan::New<Object>();
  SET_CONSTANT_NUMBER(returnValue, OC_LOG_LEVEL_ALL);
  SET_CONSTANT_NUMBER(returnValue, OC_LOG_LEVEL_INFO);
...
static Local<Object> bind_OCPayloadFormat() {
  ...
  SET_CONSTANT_NUMBER(returnValue, OC_FORMAT_VND_OCF_CBOR);
...
static Local<Object> bind_OCResourceProperty() {
  ...
  SET_CONSTANT_NUMBER(returnValue, OC_NONSECURE);
...
static Local<Object> bind_OCStackResult() {
  ...
  SET_CONSTANT_NUMBER(returnValue, OC_STACK_NOT_ALLOWED_OXM);
  SET_CONSTANT_NUMBER(returnValue, OC_STACK_BAD_ENDPOINT);
#ifdef WITH_PRESENCE
...
#endif
  SET_CONSTANT_NUMBER(returnValue, OC_STACK_USER_DENIED_REQ);
  SET_CONSTANT_NUMBER(returnValue, OC_STACK_NOT_ACCEPTABLE);
  SET_CONSTANT_NUMBER(returnValue, OC_STACK_FORBIDDEN_REQ);
  SET_CONSTANT_NUMBER(returnValue, OC_STACK_INTERNAL_SERVER_ERROR);
  SET_CONSTANT_NUMBER(returnValue, OC_STACK_GATEWAY_TIMEOUT);
...
static Local<Object> bind_OCTpsSchemeFlags() {
  Local<Object> returnValue = Nan::New<Object>();
  SET_CONSTANT_NUMBER(returnValue, OC_NO_TPS);
  SET_CONSTANT_NUMBER(returnValue, OC_COAP);
  SET_CONSTANT_NUMBER(returnValue, OC_COAPS);
#ifdef TCP_ADAPTER
  SET_CONSTANT_NUMBER(returnValue, OC_COAP_TCP);
  SET_CONSTANT_NUMBER(returnValue, OC_COAPS_TCP);
#endif
#ifdef HTTP_ADAPTER
  SET_CONSTANT_NUMBER(returnValue, OC_HTTP);
  SET_CONSTANT_NUMBER(returnValue, OC_HTTPS);
#endif
#ifdef EDR_ADAPTER
  SET_CONSTANT_NUMBER(returnValue, OC_COAP_RFCOMM);
#endif
#ifdef LE_ADAPTER
  SET_CONSTANT_NUMBER(returnValue, OC_COAP_GATT);
#endif
#ifdef NFC_ADAPTER
  SET_CONSTANT_NUMBER(returnValue, OC_COAP_NFC);
#endif
#ifdef RA_ADAPTER
  SET_CONSTANT_NUMBER(returnValue, OC_COAP_RA);
#endif
  SET_CONSTANT_NUMBER(returnValue, OC_ALL);
...
static Local<Object> bind_OCPayloadType() {
  ...
  SET_CONSTANT_NUMBER(returnValue, PAYLOAD_TYPE_DIAGNOSTIC);
  SET_CONSTANT_NUMBER(returnValue, PAYLOAD_TYPE_INTROSPECTION);
...
NAN_MODULE_INIT(InitEnums) {
  ...
  SET_ENUM(target, OCTransportBTFlags_t);
  SET_ENUM(target, OCLogLevel);
  ...
  SET_ENUM(target, OCTpsSchemeFlags);
